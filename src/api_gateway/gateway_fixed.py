...
# Service URLs from environment variables with proper service discovery defaults
TRIP_SERVICE_URL = os.getenv('TRIP_SERVICE_URL', 'http://trip-service.telematics.local:8081')
RISK_SERVICE_URL = os.getenv('RISK_SERVICE_URL', 'http://risk-service.telematics.local:8082')
PRICING_SERVICE_URL = os.getenv('PRICING_SERVICE_URL', 'http://pricing-service.telematics.local:8083')
DRIVER_SERVICE_URL = os.getenv('DRIVER_SERVICE_URL', 'http://driver-service.telematics.local:8084')
NOTIFICATION_SERVICE_URL = os.getenv('NOTIFICATION_SERVICE_URL', 'http://notification-service.telematics.local:8085')
ANALYTICS_SERVICE_URL = os.getenv('ANALYTICS_SERVICE_URL', 'http://analytics-service.telematics.local:8086')
